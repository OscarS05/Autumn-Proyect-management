...
class AuthService {
  ...
  async signToken(user){
    try {
      ...
      throw boom.badRequest(error.message || 'Failed to sign token');
    }
  }
  ...
  async sendEmailConfirmation(email){
    try {
      ...
      throw boom.badRequest(error.message || 'Failed to send email confirmation');
    }
  }
  ...
  async verifyEmailToActivateAccount(token){
    try {
      ...
      throw boom.badRequest(error.message || 'Failed to verify email to activate account');
    }
  }
  ...
  async verifyEmail(token){
    try {
      ...
      throw boom.badRequest(error.message || 'Failed to verify email');
    }
  }
  ...
  async sendMail(infoMail){
    try {
      ...
      throw boom.badRequest(error.message || 'Failed to send email');
    }
  }
