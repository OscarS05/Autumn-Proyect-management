<main id="your-projects" class="">
    ...
    <div class="container-your-projects">
        ...
        <div class="container-your-workspaces">
            ...
            <div id="container-university-workspace">
        
                <div class="container-title-buttons">
        
                    <div class="container-name-workspace">
        
                        <div id="letter-university-workspace" class="letter-workspace">
                            <span>G</span>
                        </div>
        
                        <span class="name-workspace-main">University workspace</span>
